...
//=======================================================
		public static function getInstance( $c=null, $name="", $params=array() ){
			...
			if( $name == '' ){ $name = $c; }                                                                                                
    	if( !isset( Singleton::$instances[ $name ] ) ){ Singleton::$instances[ $name ] = new $c( $params ); }
...
//=======================================================
		public function __clone(){
			//throw new Exception('Singletone clonning is not permitted. Just becase it\'s non-sense.');
		}
//
//=======================================================
